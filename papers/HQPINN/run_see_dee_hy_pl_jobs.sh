...
Usage:
  ...
  bash HQPINN/run_see_dee_hy_pl_jobs.sh --dry-run
...
add_group "HQPINN/configs/see_hy_pl_train_*.json" "HQPINN/configs/see_hy_pl_train.json"
add_group "HQPINN/configs/dee_hy_pl_train_*.json" "HQPINN/configs/dee_hy_pl_train.json"
